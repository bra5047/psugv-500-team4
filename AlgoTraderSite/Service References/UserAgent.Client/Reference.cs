...
namespace AlgoTraderSite.UserAgent.Client {
    ...
    public partial class AlertMessage : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private System.Nullable<AlgoTraderSite.UserAgent.Client.responseCodes> ResponseCodeField;
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private AlgoTraderSite.UserAgent.Client.tradeTypes TypeField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public System.Nullable<AlgoTraderSite.UserAgent.Client.responseCodes> ResponseCode {
            get {
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public AlgoTraderSite.UserAgent.Client.tradeTypes Type {
            get {
    ...
    public interface IUserAgent {
        ...
        void generateAlert(string symbolName, AlgoTraderSite.UserAgent.Client.tradeTypes type, int quantity, double price);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IUserAgent/generateAlert")]
        System.Threading.Tasks.Task generateAlertAsync(string symbolName, AlgoTraderSite.UserAgent.Client.tradeTypes type, int quantity, double price);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IUserAgent/processAlertResponse")]
        void processAlertResponse(string alertID, AlgoTraderSite.UserAgent.Client.responseCodes alertResponseCode, string alertResponse);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IUserAgent/processAlertResponse")]
        System.Threading.Tasks.Task processAlertResponseAsync(string alertID, AlgoTraderSite.UserAgent.Client.responseCodes alertResponseCode, string alertResponse);
        ...
        AlgoTraderSite.UserAgent.Client.AlertMessage[] getPendingAlerts();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IUserAgent/getPendingAlerts", ReplyAction="http://tempuri.org/IUserAgent/getPendingAlertsResponse")]
        System.Threading.Tasks.Task<AlgoTraderSite.UserAgent.Client.AlertMessage[]> getPendingAlertsAsync();
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IUserAgentChannel : AlgoTraderSite.UserAgent.Client.IUserAgent, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class UserAgentClient : System.ServiceModel.ClientBase<AlgoTraderSite.UserAgent.Client.IUserAgent>, AlgoTraderSite.UserAgent.Client.IUserAgent {
        ...
        public void generateAlert(string symbolName, AlgoTraderSite.UserAgent.Client.tradeTypes type, int quantity, double price) {
            base.Channel.generateAlert(symbolName, type, quantity, price);
        }
        
        public System.Threading.Tasks.Task generateAlertAsync(string symbolName, AlgoTraderSite.UserAgent.Client.tradeTypes type, int quantity, double price) {
        ...
        public AlgoTraderSite.UserAgent.Client.AlertMessage[] getPendingAlerts() {
            return base.Channel.getPendingAlerts();
        }
        
        public System.Threading.Tasks.Task<AlgoTraderSite.UserAgent.Client.AlertMessage[]> getPendingAlertsAsync() {
